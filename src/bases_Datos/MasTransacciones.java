...
public class MasTransacciones {
	...
	public static void main(String[] args) {
		...
		try{
			...
			String nuevoAlumno="INSERT INTO alumnos VALUES(5,'Daniel','Algebra',0)";
			objConsulta.executeUpdate(nuevoAlumno);
			
			String actualizaAlumno="UPDATE ALUMNOS SET NOTAS=80 WHERE NOMBRE='DANIEL'";
			objConsulta.executeUpdate(nuevoAlumno);
			
			int autorizacion=0;
			
			autorizacion=autorizaTransaccion();
	...
	public static int autorizaTransaccion(){	
		return JOptionPane.showConfirmDialog(null,"Autoriza la transacción?");
	}
}
